...
for match_id in authentic_match_id:
    ...
    counter += 1
np.save('atomic_move_v4_1.npy', new_X_mov, allow_pickle=True)
np.save('atomic_attack_v4_1.npy', new_X_att, allow_pickle=True)
np.save('atomic_spell_v4_1.npy', new_X_spl, allow_pickle=True)
np.save('atomic_v4_1.npy', new_X, allow_pickle=True)
