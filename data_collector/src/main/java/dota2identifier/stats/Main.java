    ...
    private void showScoreboard() {
        ...
        if (isSource1 || isEarlyBetaFormat) {
            showTableWithColumns(
                    ...
                    new ColumnDef("Steam ID", new DefaultResolver<String>("PlayerResource", "m_iPlayerSteamID.%i")),
            ...
            showTableWithColumns(
                    ...
                    new ColumnDef("Steam ID", new DefaultResolver<String>("PlayerResource", "m_vecPlayerData.%i.m_iPlayerSteamID")),
